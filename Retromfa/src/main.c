...
int main(int argc, char *argv[]) {
    ...
    // Initialize MLX before loading any images
    ...
    mfa->win_ptr = mlx_new_window(mfa->mlx_ptr, SCREEN_WIDTH, SCREEN_HEIGHT, "RetroMFA Viewer");
    if (mfa->win_ptr == NULL) {
